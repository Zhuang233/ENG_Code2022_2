...
/* Definitions for PortTask */
osThreadId_t PortTaskHandle;
const osThreadAttr_t PortTask_attributes = {
  .name = "PortTask",
  .stack_size = 128 * 4,
...
void StartPortTask(void *argument);
...
//  Testmoto_PID_Init();
  ...
  /* creation of PortTask */
  PortTaskHandle = osThreadNew(StartPortTask, NULL, &PortTask_attributes);
  ...
  /* creation of OreTask */
  OreTaskHandle = osThreadNew(StartOreTask, NULL, &OreTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CAMERA_Pin|LED_RED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, VALVE11_Pin|VALVE12_Pin|VALVE2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_GREEN_GPIO_Port, LED_GREEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PE4 CAMERA_Pin LED_RED_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_4|CAMERA_Pin|LED_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : SWITCH_STRETCH_Pin */
  GPIO_InitStruct.Pin = SWITCH_STRETCH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(SWITCH_STRETCH_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PF0 LED_GREEN_Pin */
  ...
  /*Configure GPIO pin : SWITCH_FLIP_Pin */
  GPIO_InitStruct.Pin = SWITCH_FLIP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(SWITCH_FLIP_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : VALVE11_Pin VALVE12_Pin VALVE2_Pin */
  GPIO_InitStruct.Pin = VALVE11_Pin|VALVE12_Pin|VALVE2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* USER CODE BEGIN Header_StartPortTask */
/**
* @brief Function implementing the PortTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartPortTask */
void StartPortTask(void *argument)
{
  /* USER CODE BEGIN StartPortTask */
  /* Infinite loop */
  for(;;)
  {
...
/* USER CODE BEGIN Header_StartOreTask */
/**
* @brief Function implementing the OreTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartOreTask */
void StartOreTask(void *argument)
{
  /* USER CODE BEGIN StartOreTask */
  /* Infinite loop */
  for(;;)
  {
		ore_task();
...
void StartOre_GetTask(void *argument)
{
  ...
  for(;;)
  {
		fetch_exchange_task();	//È¡¿ó¡¢¶Ò»»ÈÎÎñ
    osDelay(10);
  }
